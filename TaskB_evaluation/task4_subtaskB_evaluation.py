...
if __name__ == "__main__":
	if len(sys.argv) != 3:
		print "usage - python task4_subtaskB_evaluation.py <first file name - reference file> <second file name - estimated file> - Make sure that the files are placed in the correct path - $PWD/data/sound_event/<file is here>"	
	else:
